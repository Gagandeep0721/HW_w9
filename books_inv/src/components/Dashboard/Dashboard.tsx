       ...
       <Box sx={{ display: 'flex'}}>
        ...
        >
            <Toolbar sx={ myStyles.toolbar }>
                ...
                <Button onClick={ handleDialogOpen } sx={ myStyles.toolbarButton }> Select Book </Button>
                {/* Create Book Dialog Popup */}
                <Dialog open={ dialogOpen } onClose={ handleDialogClose } aria-labelledby='form-dialog-title'>
                    <DialogTitle id='form-dialog-title'>Add New Book</DialogTitle>
                    <DialogContent>
                        <DialogContentText> Enter Book Info Here (^_^) </DialogContentText>
                        <BookForm /> 
                    </DialogContent>
                    <DialogActions>
        ...
        <Box sx={ myStyles.content } >
            <Box sx={ myStyles.drawerHeader} />
            <Typography variant='h6'>A good book has no ending.</Typography>
            <DataTable />
        </Box>
       </Box>
    )
